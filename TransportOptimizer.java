...
class Ticket {
    ...
    @Override
    public String toString() {
        return "Ticket ID: " + ticketId + ", From: " + source.getName() + ", To: " + destination.getName() + ", Fare: "
                + fare + "/- Rupees" + ", Date: " + date;
    }
}
...
public class TransportOptimizer {
    ...
    private static int calculateFare(City source, City destination) {
        ...
        if (route != null) {
            int baseFare = route.getDistance() * 7;
    ...
    private static void bookTicket() {
        ...
        System.out.println("Ticket booked successfully! Fare: " + fare + "/- Rupees");
    }
